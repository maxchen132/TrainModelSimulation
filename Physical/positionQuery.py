...
# currently in progress: copied from updateGUIValues
# goal: pull values from track elements annd trains and output them in structured JSON

class positionQuery(jmri.jmrit.automat.AbstractAutomaton) :
    def init(self):
